<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListaArtigos.aspx.cs" Inherits="ListaArtigos.ListaArtigos" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div>
            <asp:DropDownList ID="idDListTemas" runat ="server" OnSelectedIndexChanged="idDListTemas_SelectedIndexChanged" AutoPostBack="True"> 
                <asp:ListItem Selected="True" Value="Temas">Temas</asp:ListItem>
                <asp:ListItem value ="Alimentação">Alimentação</asp:ListItem>
         ...
         <div>
              <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [ARTIGO] WHERE ([tema] = @tema)" DeleteCommand="DELETE FROM [ARTIGO] WHERE [idArtigo] = @idArtigo" InsertCommand="INSERT INTO [ARTIGO] ([dataHora], [autor], [titulo], [texto], [ordemRelevancia], [idPagina], [tema], [subTema], [ativo], [urlVideo], [urlFoto]) VALUES (@dataHora, @autor, @titulo, @texto, @ordemRelevancia, @idPagina, @tema, @subTema, @ativo, @urlVideo, @urlFoto)" UpdateCommand="UPDATE [ARTIGO] SET [dataHora] = @dataHora, [autor] = @autor, [titulo] = @titulo, [texto] = @texto, [ordemRelevancia] = @ordemRelevancia, [idPagina] = @idPagina, [tema] = @tema, [subTema] = @subTema, [ativo] = @ativo, [urlVideo] = @urlVideo, [urlFoto] = @urlFoto WHERE [idArtigo] = @idArtigo">
                  ...
                  <SelectParameters>
                      <asp:ControlParameter ControlID="idDListTemas" Name="tema" PropertyName="SelectedValue" Type="String" />
                  </SelectParameters>
                  <UpdateParameters>
                      <asp:Parameter DbType="DateTime2" Name="dataHora" />
                      <asp:Parameter Name="autor" Type="String" />
              ...
              <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="idArtigo" DataSourceID="SqlDataSource1" OnSelectedIndexChanged="GridView1_SelectedIndexChanged1">
                  <Columns>
        ...
        <div>
            ...
            Tema:<br />
            <asp:Label ID="idLbTema" runat="server" Text="Label"></asp:Label><br />
            Autor:<br />
            <asp:Label ID="idLbAutor" runat="server" Text="Label"></asp:Label><br />
            Data Hora:<br />
            <asp:Label ID="idLbDataHora" runat="server" Text="Label"></asp:Label><br />
            Texto:<br />
            <asp:Label ID="idLbTexto" runat="server" Text="Label"></asp:Label><br />
            URL:<br />
            <asp:Label ID="idLbURL" runat="server" Text="Label"></asp:Label><br />
        </div>
    </form>
</body>
</html>
